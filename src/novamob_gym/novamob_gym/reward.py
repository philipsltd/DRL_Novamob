...
def get_reward_1(cummulative_reward, robot_status):
...
def get_reward(cummulative_reward, robot_status):
    ...
    if function_to_use in function_dict:
        ...
        reward = function_dict[function_to_use](cummulative_reward, robot_status)
        return reward
    else:
